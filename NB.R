...
class(sms_data)
str(sms_data)
sms_data$type<-factor(sms_data$type) #converting text into factor form
str(sms_data)
table(sms_data$type) #says no.of spam and ham are present in a data
